...
$size = "<font size=2>" ;
     ...
     $colA = "1241" ; $dateA = "06-01-2014" ;
     $colB = "1291" ; $dateB = "29-12-2014" ;

// List New Totals by Runs

$sql = "select hasher, name, runs, hared from inters_2014 where runs > 0 or class='A0' or class='B0' or class='C0' or class='D0'

  order by class, hared DESC, runs DESC, hasher ASC limit 0,300" ;

$dbq=mysql_query($sql,$dbc) or die ("Couldn't list inters.") ;

echo "<center>$size<bold>fotmh3 - ANNUAL RUNS STATISTICS FOR 2014.</br>" ;
