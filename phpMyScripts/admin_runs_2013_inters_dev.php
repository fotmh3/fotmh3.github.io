...
$size = "<font size=2>" ;
     ...
     $colA = "1188" ; $dateA = "07-01-2013" ;
 
     $colB = "1240" ;  $dateB = "23-12-2013" ;

// List New Totals by Runs

$sql = "select hasher, name, runs, hared from inters_2013 where runs > 0 or class='A0' or class='B0' or class='C0' or class='D0'

  order by class, hared DESC, runs DESC, hasher ASC limit 0,300" ;

$dbq=mysql_query($sql,$dbc) or die ("Couldn't list inters.") ;

echo "<center>$size<bold>fotmh3 - ANNUAL RUNS STATISTICS FOR 2013.</br>" ;
