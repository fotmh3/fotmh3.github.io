...
$size = "<font size=2>" ;
     ...
     $colA = "1391" ; $dateA = "08-01-2017" ;
     $colB = "1440" ; $dateB = "18-12-2017" ;

// List New Totals by Runs

$sql = "select hasher, name, runs, hared from inters_2017 where runs > 0 or class='A0' or class='B0' or class='C0' or class='D0'

  order by class, hared DESC, runs DESC, hasher ASC limit 0,300" ;

$dbq=mysql_query($sql,$dbc) or die ("Couldn't list inters.") ;

echo "<center>$size<bold>fotmh3 - ANNUAL RUNS STATISTICS FOR 2017.</br>" ;
