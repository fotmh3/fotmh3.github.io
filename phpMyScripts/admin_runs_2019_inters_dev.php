...
$size = "<font size=2>" ;
     ...
     $colA = "1483" ; $dateA = "06-01-2019" ;
     $colB = "1509" ; $dateB = "22-12-2019" ;

// List New Totals by Runs

// $sql = "select hasher, name, runs, hared from inters_2019 where runs > 0 or class='A0' or class='B0' or class='C0' or class='D0'   order by class, hared DESC, runs DESC, hasher ASC limit 0,300" ;

$sql = "select hasher, name, runs, hared from inters_2019 where runs > 0 or class='A0' or class='B0' or class='C0' or class='D0'   order by class, name ASC limit 0,300" ;


$dbq=mysql_query($sql,$dbc) or die ("Couldn't list inters.") ;

echo "<center>$size<bold>fotmh3 - ANNUAL RUNS STATISTICS FOR 2019.</br>" ;
