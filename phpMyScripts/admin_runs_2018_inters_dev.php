...
$size = "<font size=2>" ;
     ...
     $colA = "1441" ; $dateA = "07-01-2018" ;
     $colB = "1482" ; $dateB = "16-12-2018" ;

// List New Totals by Runs

$sql = "select hasher, name, runs, hared from inters_2018 where runs > 0 or class='A0' or class='B0' or class='C0' or class='D0'

  order by class, hared DESC, runs DESC, hasher ASC limit 0,300" ;

$dbq=mysql_query($sql,$dbc) or die ("Couldn't list inters.") ;

echo "<center>$size<bold>fotmh3 - ANNUAL RUNS STATISTICS FOR 2018.</br>" ;
