...
$size = "<font size=3>" ;
     ...
     $colA = "1292" ; $dateA = "04-01-2015" ;
 
     $colB = "1340" ;  $dateB = "21-12-2015" ;

// List New Totals by Runs

$sql = "select hasher, name, runs, hared from inters_2015 where runs > 0 or class='A0' or class='B0' or class='C0' or class='D0'

  order by class, hared DESC, runs DESC, hasher ASC limit 0,300" ;

// $dbq=mysql_query($sql,$dbc) or die ("Couldn't list inters.") ;

echo "<center>$size<bold>fotmh3 - ANNUAL RUNS STATISTICS FOR 2015.</br>" ;
